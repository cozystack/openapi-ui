...
import { getLogo, getLogoText, getTenantText } from 'utils/env'
...
export const Logo: FC = () => {
  ...
  const customLogoText = getLogoText()
  const customTenantText = getTenantText()
  ...
  const renderLogo = () => {
    if (customLogo) {
      ...
      try {
        ...
        const svgWithFill = decodedSvg.replace(/\{token\.colorText\}/g, `"${token.colorText}"`)
